...
class HomepagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homepage" do
    assert_difference("Homepage.count") do
      post homepages_url, params: { homepage: { introduction: @homepage.introduction, title: @homepage.title } }
    end
  ...
  test "should update homepage" do
    patch homepage_url(@homepage), params: { homepage: { introduction: @homepage.introduction, title: @homepage.title } }
